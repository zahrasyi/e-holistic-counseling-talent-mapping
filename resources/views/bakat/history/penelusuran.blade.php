<x-layouts.app>
    <!-- Tambahan CSS untuk menangani efek hover tombol -->
    <style>
    ...
    <div class="p-8 min-h-[70vh]">
        <div class="max-w-4xl mx-auto">
            ...
            <h2 class="text-2xl font-bold mb-6" style="color: #34538c;">
                <i class="fas fa-search mr-2"></i> Riwayat Penelusuran
            </h2>
            
            <!-- Filter -->
            <form method="GET" action="{{ route('talent.history.penelusuran') }}" class="mb-6 flex gap-2 items-center p-4 rounded-xl border" style="background-color: #ffffff; border-color: #e5e7eb;">
                ...
                <a href="{{ route('talent.history.penelusuran') }}" class="font-semibold px-4 transition-all duration-300 btn-reset">Reset</a>
            </form>
                    ...
                    <tbody class="divide-y" style="border-color: #f3f4f6;">
                        ...
                        <tr>
                            ...
                            <td class="p-4 text-center">
                                <a href="{{ route('talent.hasil', ['id' => $item->id]) }}" class="inline-flex items-center justify-center w-8 h-8 rounded-full transition-all duration-300 btn-eye" title="Lihat Detail">
