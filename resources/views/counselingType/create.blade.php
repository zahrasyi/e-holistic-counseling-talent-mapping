<div>
    <x-layouts.app>
        ...
        <x-partials.header title="Manajemen Tipe Konseling" description="Buat Tipe Konseling Disini." />
        ...
        <div
            ...
            <h2 class="py-6 text-xl font-bold text-gray-900 dark:text-white">Buat Tipe Konseling Baru</h2>
            <hr class="border border-gray-300 dark:border-gray-600">

            <form action="{{ route('counselingType.store') }}" enctype="multipart/form-data" method="POST">
                @csrf
                ...
                <div class="flex items-center space-x-4 mt-4 sm:mt-6">
                    <button
                        class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Buat</button>
