<div class="flex items-center space-x-2">
    ...
    {{-- <a href="#" class="group relative flex items-center">
        ...
        <span
            ...
            Show Detail Specialization
        </span>
    </a> --}}

    <a href="{{ route('counselingType.edit', $counselingType->id) }}" class="group relative flex items-center">
    ...
    <form action="{{ route('counselingType.destroy', $counselingType->id) }}" method="POST" class="inline"
