<x-layouts.app>
    ...
    <x-partials.header title="Create Roles" description="Create Master Roles Disini." />
    ...
    <div
        ...
        <h2 class="py-6 text-xl font-bold text-gray-900 dark:text-white">Buat Role Baru</h2>
