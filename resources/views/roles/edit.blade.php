<x-layouts.app>
    ...
    <x-partials.header title="Edit Roles" description="Edit Master Roles Disini." />
    ...
    <div
        ...
        <h2 class="py-6 text-xl font-bold text-gray-900 dark:text-white">Edit Role Baru</h2>
