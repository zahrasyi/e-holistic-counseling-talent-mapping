<div class="flex items-center space-x-2">
    ...
    <a href="{{ route('roles.show', $role->id) }}" class="group relative flex items-center">
    ...
    <a href="{{ route('roles.edit', $role->id) }}" class="group relative flex items-center">
    ...
    <form action="{{ route('roles.show', $role->id) }}" method="POST" class="inline"
        ...
        <button type="submit" class="group relative flex items-center">
            <div class="p-2 text-red-500 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
