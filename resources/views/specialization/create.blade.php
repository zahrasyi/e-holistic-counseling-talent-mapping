<div>
    <x-layouts.app>
        ...
        <x-partials.header title="Manajemen Spesialisasi" description="Buat Spesialisasi Disini.">
            <x-slot name="actions">
        ...
        <div
            ...
            <h2 class="py-6 text-xl font-bold text-gray-900 dark:text-white">Buat Spesialisasi Baru</h2>
            ...
            <form action="{{ route('specialization.store') }}" method="POST">
                ...
                {{--  partial _form --}}
                @include('specialization.partials._form')
