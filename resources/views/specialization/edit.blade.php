<x-layouts.app>
    ...
    <x-partials.header title="Manajemen Spesialisasi" description="Edit Spesialisasi Disini." />
    ...
    <div
        ...
        <h2 class="py-6 text-xl font-bold text-gray-900 dark:text-white">Edit Spesialisasi Baru</h2>
