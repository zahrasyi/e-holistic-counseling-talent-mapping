<x-layouts.app>
    ...
    <div
        class="mt-10 px-8 mx-auto w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-md">

        <h2 class="py-6 text-xl font-bold text-gray-900 dark:text-white">Edit User Baru</h2>
